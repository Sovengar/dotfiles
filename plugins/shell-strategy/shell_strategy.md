...
**Context:** OpenCode's shell environment is strictly **non-interactive** meaning any command that waits for user input, confirmation, or launches a UI (editor/pager) will hang indefinitely and timeout.
...
This strategy enforces strict cognitive patterns. These are not just shell tips; they are **behavioral requirements** for success in this environment.
