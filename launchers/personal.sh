#!/usr/bin/env bash
#
# Public launcher for linux-personal (CachyOS desktop).
...
REPO_URL="https://github.com/Sovengar/dotfiles-linux-personal.git"
...
auth_github() {
  ...
  echo ""
  echo "If you're on a desktop with a browser, gh will open the login page."
  echo "If you're on a headless server, gh will show a device code."
