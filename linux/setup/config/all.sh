...
run_logged "$_PHASE_DIR/20-user-services.sh"
run_logged "$_PHASE_DIR/25-zen-browser-config.sh"
run_logged "$_PHASE_DIR/30-bind-mounts.sh"
run_logged "$_PHASE_DIR/05-icon-cache.sh"
run_logged "$_PHASE_DIR/10-opencode-quota.sh"
