---
name: tools-editorconfig
description: 'Generates a comprehensive and best-practice-oriented .editorconfig file based on project analysis and user preferences.'
decisionFramework: "New project → create .editorconfig. Existing project → if no .editorconfig, create one. Otherwise keep existing."
---
...
| Scenario | Action |
|----------|--------|
| **New project** | → Create .editorconfig |
| **Existing project without .editorconfig** | → Create .editorconfig |
| **Existing project with .editorconfig** | → Keep existing, don't replace |
| **Doubts** | → Ask user |
