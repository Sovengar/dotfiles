...
if [[ -r $HYPRLAND_CONFIG ]]; then
    ...
    mkdir -p "$XDG_CONFIG_HOME/hypr/autogenerated_files"
    [[ -r "$HYDE_THEME_DIR/hypr.theme" ]] && sanitize_hypr_theme "$HYDE_THEME_DIR/hypr.theme" "$XDG_CONFIG_HOME/hypr/autogenerated_files"
