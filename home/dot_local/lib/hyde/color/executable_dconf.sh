...
if [[ $HYPRLAND_CONFIG == *.lua ]]; then
    HYDE_HYQ_CONFIG="${HYPR_GENERATED_DIR:-${XDG_STATE_HOME:-$HOME/.local/state}/hypr}/metadata.conf"
    legacy_hyq_config="${XDG_CONFIG_HOME:-$HOME/.config}/hypr/autogenerated_files/metadata.conf"
