...
mkdir -p "$confDir/hypr/autogenerated_files"
cat <<WALLBASH >"$confDir/hypr/autogenerated_files/wallbash.conf"
...
# // ----------------------------
WALLBASH
if grep -q "#//---Wallbash mode enabled---" "$confDir/hypr/autogenerated_files/wallbash.conf"; then
    sed -i '/#\/\/---Wallbash mode enabled---/,$d' "$confDir/hypr/autogenerated_files/wallbash.conf"
fi
if [[ $enableWallDcol -gt 0 ]]; then
    cat <<ON_WALLBASH >>"$confDir/hypr/autogenerated_files/wallbash.conf"
