...
WAYBAR_GENERATED_DIR = Path(os.path.join(str(xdg_state_home()), "waybar"))
GENERATED_CONFIG_JSONC = WAYBAR_GENERATED_DIR / "config.jsonc"
GENERATED_STYLE_CSS = WAYBAR_GENERATED_DIR / "style.css"
GENERATED_THEME_CSS = WAYBAR_GENERATED_DIR / "theme.css"
GENERATED_INCLUDES_DIR = WAYBAR_GENERATED_DIR / "includes"
GENERATED_INCLUDES_JSON = GENERATED_INCLUDES_DIR / "includes.json"
GENERATED_GLOBAL_CSS = GENERATED_INCLUDES_DIR / "global.css"
GENERATED_BORDER_RADIUS_CSS = GENERATED_INCLUDES_DIR / "border-radius.css"
GENERATED_BACKUP_DIR = WAYBAR_GENERATED_DIR / "layouts" / "backup"

CONFIG_JSONC = GENERATED_CONFIG_JSONC
STATE_FILE = Path(os.path.join(str(xdg_state_home()), "waybar", "staterc"))
WAYBAR_CONFIG = STATE_FILE
...
def get_config_value(key, default=None):
    ...
    if WAYBAR_CONFIG.exists():
        with open(WAYBAR_CONFIG, "r") as file:
            for line in file:
...
def write_style_file(style_filepath, source_filepath):
    ...
    generated_includes_dir = str(GENERATED_INCLUDES_DIR)
    user_style_path = os.path.join(str(xdg_config_home()), "waybar", "user-style.css")
    theme_path = str(GENERATED_THEME_CSS)
    style_css = f"""
    ...
    */
    ...
    /* Generated by HyDE — do not edit, changes will be overwritten */
    /* Editable sources: ~/.config/waybar/styles/ and ~/.config/waybar/user-style.css */
    /* Generated outputs: ~/.local/state/waybar/ */

    /* Active layout style */
    @import "{source_filepath}";

    /* Dynamic includes (border-radius, global font/size) */
    @import "{generated_includes_dir}/border-radius.css";
    @import "{generated_includes_dir}/global.css";
...
def run_waybar():
    ...
    subprocess.run(
        [
            ...
            "--",
            "waybar",
            "-c", str(GENERATED_CONFIG_JSONC),
            "-s", str(GENERATED_STYLE_CSS),
        ]
    )
...
def backup_layout(layout_name):
    ...
    backup_dir = str(GENERATED_BACKUP_DIR)
...
def update_icon_size():
    includes_file = str(GENERATED_INCLUDES_JSON)
...
def update_global_css():
    ...
    global_css_path = str(GENERATED_GLOBAL_CSS)
...
def update_border_radius():
    css_filepath = str(GENERATED_BORDER_RADIUS_CSS)
...
def update_style(style_path):
    ...
    theme_style_filepath = str(GENERATED_THEME_CSS)

    ensure_directory_exists(style_filepath)
...
def main():
    ...
    source_env_file(os.path.join(str(xdg_state_home()), "waybar", "staterc"))
