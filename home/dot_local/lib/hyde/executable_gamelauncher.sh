...
case "$backend" in
    steam)
        backend_command=("$LIB_DIR/hyde/python_env/bin/python" "$LIB_DIR/hyde/gamelauncher/steam.py" --rofi-string)
        ;;
    lutris)
        backend_command=("$LIB_DIR/hyde/python_env/bin/python" "$LIB_DIR/hyde/gamelauncher/lutris.py" --rofi-string)
        ;;
    *)
        backend_command=("$LIB_DIR/hyde/python_env/bin/python" "$LIB_DIR/hyde/gamelauncher/catalog.py" --rofi-string)
