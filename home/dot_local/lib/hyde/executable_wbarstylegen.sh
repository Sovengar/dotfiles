...
src_file="${HYPR_GENERATED_DIR:-${XDG_STATE_HOME:-$HOME/.local/state}/hypr/generated}/waybar.theme.conf"
legacy_src_file="$confDir/hypr/autogenerated_files/waybar.theme.conf"
