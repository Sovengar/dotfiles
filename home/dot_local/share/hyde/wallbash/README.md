...
4. Use this directory as the local template source. Upstream HyDE used `Configs/.config/hyde/wallbash` historically, but this dotfiles setup keeps the unified Wallbash source under `~/.local/share/hyde/wallbash`.
...
The `~/.local/share/hyde/wallbash/*` directory contains three main directories:
