...
WALLBASH_SCRIPTS="${WALLBASH_SCRIPTS:-${XDG_DATA_HOME:-$HOME/.local/share}/hyde/wallbash/scripts}"
hypr_border=10
...
# to change font and size, update the dunst/wallbash-specific template/config.
# [notification]
