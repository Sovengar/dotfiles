...
name: go-testing
description: >
  Go testing patterns, including Bubbletea TUI testing with teatest.
  Trigger: When writing Go tests, using teatest, or adding test coverage.
tags: [go, testing, teatest, tui, bubbletea]
triggers: [go-testing, go-test, teatest, golang-testing, bubbletea]
---
