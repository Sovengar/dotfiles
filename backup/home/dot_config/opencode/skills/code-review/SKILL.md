...
name: code-review
description: >
  Parallel adversarial code review protocol that launches two independent blind judge sub-agents
  simultaneously to review the same code target, synthesizes their findings, applies fixes,
  and re-judges until both pass or escalates after 2 iterations.
  Trigger: When user says "code review", "design review", "judgment day", "review adversarial",
  "dual review", "doble review", "revisar código", "revisar cambios", "revisar lo que hice",
  "pendiente de commit", "sin commit", "juzgar", "que lo juzguen".
tags: [code-review, adversarial, review, dual-review]
triggers: [code-review, design-review, judgment-day, review adversarial, dual review, doble review, juzgar, que lo juzquen, revisar código, revisar cambios, revisar ultimos cambios, pendiente de commit, sin commit, revisar lo que hice, revisar mi código, revisión de código, revisar, revisame, échale un vistazo]
---
...
- Edge Cases (AI): Did the AI account for empty states, timeouts, and partial failures?
- External State: Is the code making safe assumptions about file systems or networks?
- Prompt Injection: Are user inputs sanitized before being used in prompts?
- Output Sanitization: Are outputs sanitized before being used in critical sinks?
...
Use emoji prefixes to indicate severity:

| Prefix | Meaning | Action |
|--------|---------|--------|
| 🔴 BLOCKING | Critical issue, must fix | Stop, fix before merge |
| 🟡 SUGGESTION | Important improvement | Consider fixing |
| 🟢 NIT | Minor nitpick | Optional fix |
| ❓ QUESTION | Needs clarification | Ask for context |

**Example:**
```markdown
🔴 BLOCKING: SQL injection vulnerability in user input at line 42
🟡 SUGGESTION: Consider using useMemo for expensive computation
