...
configure_spicetify() {
    ...
    local sleek_theme_dir="${spicetify_themes_dir}/Sleek"
    local wallbash_color_ini="${cache_dir}/wallbash/spotify-color.ini"
    ...
    mkdir -p "${sleek_theme_dir}"
    [ -f "${wallbash_color_ini}" ] && cp "${wallbash_color_ini}" "${sleek_theme_dir}/color.ini"
